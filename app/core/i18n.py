...
TRANSLATIONS: dict[str, dict[str, str]] = {
    ...
    "layout_editor.delete_selected": {"ja": "選択した装置を削除", "en": "Delete Selected Items"},
    "layout_editor.align_label": {"ja": "位置を揃える", "en": "Align"},
    "layout_editor.align_left": {"ja": "左揃え", "en": "Left"},
    "layout_editor.align_center_x": {"ja": "横中央揃え", "en": "Center X"},
    "layout_editor.align_right": {"ja": "右揃え", "en": "Right"},
    "layout_editor.align_top": {"ja": "上揃え", "en": "Top"},
    "layout_editor.align_center_y": {"ja": "縦中央揃え", "en": "Center Y"},
    "layout_editor.align_bottom": {"ja": "下揃え", "en": "Bottom"},
    "layout_editor.distribute_label": {"ja": "均等配置", "en": "Distribute"},
    "layout_editor.distribute_horizontal": {"ja": "横方向", "en": "Horizontal"},
    "layout_editor.distribute_vertical": {"ja": "縦方向", "en": "Vertical"},
